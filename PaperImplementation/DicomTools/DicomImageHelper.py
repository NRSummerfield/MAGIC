...
def get_contours_coords(roi_data: ROIData, series_data, contour_resolution=None):
    transformation_matrix = get_pixel_to_patient_transformation_matrix(series_data, contour_resolution=contour_resolution)
...
def get_pixel_to_patient_transformation_matrix(series_data, contour_resolution=None):
    """
    ...
    if contour_resolution is not None:
        print('OverWriting spacing to match rts')
        row_spacing, column_spacing = contour_resolution
