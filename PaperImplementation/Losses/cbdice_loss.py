import torch
from .monai_distance_transform_edt import distance_transform_edt
from .skeletonize import Skeletonize
from .soft_skeleton import SoftSkeletonize

class SoftcbDiceLoss(torch.nn.Module):
    def __init__(self, iter_=10, smooth = 1, default_topology=False):
    ...
    def forward(self, y_pred, y_true, t_skeletonize_flag=None):
        """
        ...
        """
        if t_skeletonize_flag is None:
            t_skeletonize_flag = self.default_topology
