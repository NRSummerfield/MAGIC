...
from . import DicomStructureHelper as ds_helper
from . import DicomImageHelper as image_helper
...
class RTStruct:
    ...
    def add_roi(
        ...
        contour_resolution: Optional[Union[float, list[float]]] = None
    ):
        """
        ...
        self.ds.ROIContourSequence.append(
            ds_helper.create_roi_contour(roi_data, self.series_data, contour_resolution)
        )
