...
class SoftclDiceLoss(torch.nn.Module):
    def __init__(self, iter_=10, smooth = 0.1, default_topology: bool = False):
    ...
    def forward(self, y_pred, y_true, t_skeletonize_flage=None):
        """
        ...
        """
        if t_skeletonize_flage is None:
            t_skeletonize_flage = self.default_topology
